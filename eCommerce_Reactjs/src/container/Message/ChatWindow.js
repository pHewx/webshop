  ...
  let sendMessage = () => {
    ...
    return (
        ...
        <div className="ks-body ks-scrollable jspScrollable" data-auto-height data-reduce-height=".ks-footer" data-fix-height={32} style={{height: '480px', overflow: 'hidden', padding: '0px'}} tabIndex={0}>
          <div  className="jspContainer" style={{height: '481px'}}>
            <div  className="jspPane" style={{padding: '0px', top: '0px'}}>
              <ul id="box-chat" className="ks-items" style={{overflowY:'scroll', minHeight:'479px', maxHeight:'479px'}}>
                {mess && mess.length > 0 &&
                 mess.map((item,index) =>{
                 if(item.userData){
                  return(
                    ...
                    <span className="ks-avatar ks-offline">
                      <img src={item.userData.image ? item.userData.image : "https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"} width={36} height={36} className="rounded-circle" />
                    </span>
        ...
        <div className="ks-footer">
          ...
          <div className="ks-controls" style={{justifyContent: 'flex-end', width: 'auto'}}>

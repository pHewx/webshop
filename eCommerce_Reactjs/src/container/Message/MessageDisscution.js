...
// console.log(roomList)
    return (
        ...
        <div className="ks-body ks-scrollable jspScrollable" data-auto-height style={{height: '600px', overflowY: 'auto', padding: '0px', width: '339px'}} tabIndex={0}>
          <div className="jspContainer" style={{width: '339px'}}>
                ...
                return(
                  ...
                  <a href="#">
                    <span className="ks-avatar">
                      <img src={userData.image ? userData.image : "https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"} width={36} height={36} />
